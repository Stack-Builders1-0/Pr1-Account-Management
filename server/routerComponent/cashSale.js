...
router.post('/add', (req, res) => {
    ...
    const insertQuery = "insert into accountmanagement.cash_sales (type_id,manual_invoice_id, customer_id, description, bill_amount, discount, employee_id ) values (?,?,?,?,?,?,?);";
...
router.get('/showAll', (req, res) => {
    ...
    const selectQuery = "SELECT invoice_id, accountmanagement.cash_sales.type_id, type, manual_invoice_id,customer_id, description, bill_amount, discount, date  FROM accountmanagement.cash_sales join accountmanagement.income_type using (type_id) order by(date) desc;";
