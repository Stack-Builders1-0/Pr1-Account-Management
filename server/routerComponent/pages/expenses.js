...
//   const insertQuery =
//     "insert into accountmanagement.employees (employee_name, address, mobile, email, nic, type_id, age, password) values(?,?,?,?,?,?,?,?);";
...
//💢🎉🌹🎉 Ithu Naan Try pannathuda

router.get("/showAll", (req, res) => {
  const selectQuery =
    "SELECT expense_id, type,description, net_total FROM expenses;";
...
//     const selectQuery =
//       "SELECT employee_id, employee_name, type, address, mobile, email, nic, age FROM employees join employee_type using(type_id) where employee_id = " +
