...
function AddCustomer() {
  ...
  const findFormErrors = () => {
    ...
    else if (customer_name.length > 30)
      newErrors.customer_name = "firstName is too long!";
    ...
    if (!credit_limit || credit_limit === "")
      newErrors.credit_limit = "cannot be blank!";
  ...
  const handleSubmit = (event) => {
    ...
    if (Object.keys(newErrors).length > 0) {
      ...
      axios
        .post(import.meta.env.VITE_API_URL + "/customer/add", form, {
        ...
        <Form onSubmit={handleSubmit}>
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control
              ...
              autoComplete="off"
              onChange={(e) => setField("office_num", e.target.value)}
            />
          </Form.Group>
